...
INSERT INTO "new_ExpenseReport" ("approvedAt", "breakfasts", "completedAt", "countryCode", "createdAt", "destination", "dinners", "employeeId", "endAt", "id", "lunches", "privateKilometers", "purpose", "startAt", "status", "submittedAt", "title", "transportType", "updatedAt") SELECT "approvedAt", "breakfasts", "completedAt", "countryCode", "createdAt", "destination", "dinners", "employeeId", "endAt", "id", "lunches", "privateKilometers", "purpose", "startAt", "status", "submittedAt", "title", "transportType", "updatedAt" FROM "ExpenseReport";
